                                                                                                            ...
                                                                                                            pkgs.writeShellScript
                                                                                                                ...
                                                                                                                ''
                                                                                                                    ...
                                                                                                                    EOF
                                                                                                                        ...
                                                                                                                        ${ pkgs.git }/bin/git config alias.subscribe !${ pkgs.writeShellScript "subscript" "${ pkgs.redis }/bin/redis-cli SUBSCRIBE git-commits nix-flake-check | while read -r line; do ${ pkgs.coreutils }/bin/echo "${ _environment-variable "line" }"; done"
