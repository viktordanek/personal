                                                            ...
                                                            in
                                                                {
                                                                    index =
                                                                        let
                                                                            ...
                                                                            list = builtins.trace "a132782b-365a-4999-a7f3-ced24634a5d6 ${ builtins.typeOf dependencies } ${ builtins.toJSON dependencies }" ( builtins.attrValues ( builtins.mapAttrs ( name : value : { name = name ; value = value ; } ) dependencies ) ) ;
