                                                                                        ...
                                                                                        in
                                                                                            ''
                                                                                                ...
                                                                                                then
                                                                                                    ...
                                                                                                    mkdir --parents "$LINK"
                                                                                                    ${ builtins.concatStringsSep "" ( builtins.map ( dependency : builtins.concatStringsSep "\n" ( output : ''if [ ! -e "${ builtins.concatStringsSep "/" [ "$LINKED" dependency output ] }" ] ; then ${ yaml 13579 } && rm "$ROOT/lock" && flock -u 201 && exit 64'' ) ( builtins.getAttr dependency outputs ) ) ( builtins.trace "d9fcfc8c-35d4-4b57-a150-160ef0227383 [ ${ builtins.concatStringsSep " , " ( builtins.map builtins.typeOf resource.dependencies ) } ] ${ builtins.toJSON resource.dependencies }" resource.dependencies ) ) }
