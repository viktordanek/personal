                                                                        ...
                                                                        mapper =
                                                                            value :
                                                                                [
                                                                                    ...
                                                                                    ''if [ ! -d ${ _environment-variable "DIRECTORY" } ] ; then ${ pkgs.coreutils }/bin/mkdir ${ _environment-variable "DIRECTORY" } && ${ pkgs.git }/bin/git init && ${ pkgs.git }/bin/git config core.sshCommand ${ pkgs.openssh }/bin/ssh -i ${ value.identity-file } && git remote add origin ${ value.remote } ; fi''
                                                                                ] ;
