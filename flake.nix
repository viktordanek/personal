                                                                                        ...
                                                                                        let
                                                                                            ...
                                                                                            nix-flake-check =
                                                                                                pkgs.writeShellScript
                                                                                                    ...
                                                                                                    '' ;
                                                                                            in ''if [ ! -d ${ _environment-variable "DIRECTORY" } ] ; then ${ pkgs.coreutils }/bin/mkdir ${ _environment-variable "DIRECTORY" } && cd ${ _environment-variable "DIRECTORY" } && ${ pkgs.git }/bin/git init --bare && ${ pkgs.git }/bin/git config core.sshCommand "${ pkgs.openssh }/bin/ssh -i ${ _environment-variable "DIRECTORY" }.id-rsa -o StrictHostKeyChecking=accept-new" && ${ pkgs.git }/bin/git remote add origin ${ value.remote } && ${ pkgs.git }/bin/git fetch --all --prune --tags && ${ pkgs.git }/bin/git branch main origin/main && ${ pkgs.git }/bin/git symbolic-ref HEAD refs/heads/main ; fi''
                                                                                    )
                                                                                ] ;
