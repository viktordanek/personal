                                                                                                            ...
                                                                                                            pkgs.stdenv.mkDerivation
                                                                                                                {
                                                                                                                    installPhase =
                                                                                                                        ...
                                                                                                                        ''
                                                                                                                            ...
                                                                                                                            ln --symbolic ${ pkgs.writeShellScript "application" ( builtins.concatStringsSep "\n" ( builtins.map ( secretFile : ''mkdir --parents $( direname secretFile ) && age --decrypt --identity ${ config.personal.agenix } --output secretFile $out/src/${ secretFile } && chmod 0400 ${ secretFile }'' ) secretFiles ) ) } $out/scripts/application
