                                                                                                ...
                                                                                                ''
                                                                                                    ...
                                                                                                    then
                                                                                                        ${ pkgs.coreutils }/bin/mkdir ${ _environment-variable "PORTFOLIO" } &&
                                                                                                            ${ pkgs.coreutils }/bin/echo -e "export TIMESTAMP=${ _environment-variable "TIMESTAMP" } \n export PORTFOLIO=${ _environment-variable "PORTFOLIO" } \n export OUT=${ _environment-variable "OUT" }" >> /tmp/DEBUG &&
