                                                ...
                                                mapper =
                                                    resource :
                                                        let
                                                            ...
                                                            index =
                                                                let
                                                                    index = builtins.genList ( index : { index = index ; value = builtins.elemAt index sort ; } ) ( builtins.length sort ) ;
                                                                    ...
                                                                    in builtins.length ( builtins.trace ( builtins.toJSON index ) index ) ;
