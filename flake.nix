                                                                                ...
                                                                                let
                                                                                    ...
                                                                                    tree =
                                                                                        visitor.lib.implementation
                                                                                            ...
                                                                                            resources ;
                                                                                    in builtins.trace "528e19fc-c058-41e6-844e-48366510a16d ${ builtins.toJSON tree }" ( builtins.map ( dependency : if builtins.elem dependency list then dependency else builtins.throw "dependency ${ builtins.toString dependency } is not correct." ) ( dependencies tree ) ) ;
