                                                                                                            ...
                                                                                                            let
                                                                                                                experience =
                                                                                                                    let
                                                                                                                        mapper =
                                                                                                                            experience :
                                                                                                                                ''### ${ experience.title } at ${ experience.company } $( ${ pkgs.coreutils }/bin/date "+${ value.date-mask }" --date @${ builtins.toString experience.from } ) - $( ${ pkgs.coreutils }/bin/date "+${ value.date-mask }" --date @${ builtins.toString experience.to } )'' ;
