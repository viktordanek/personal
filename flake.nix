                                                                                                            ...
                                                                                                            ''
                                                                                                                ...
                                                                                                                then
                                                                                                                    ...
                                                                                                                    then
                                                                                                                        ...
                                                                                                                        then
                                                                                                                            jq --null-input --arg EXPECTED "${ builtins.concatStringsSep "," point.outputs }" --arg OBSERVED "$( find "$STASH/mount" -mindepth 1 -maxdepth 1 )" --arg STANDARD_ERROR "$( cat "$STASH/standard-error" )"  --arg STANDARD_OUTPUT "$( cat "$STASH/standard-output" )" --arg STATUS "$?" '{ "expected" : $EXPECTED  , "failure" :  17997 , "observed" : $OBSERVED , "standard-error" : $STANDARD_ERROR , "standard-output" : $STANDARD_OUTPUT , "status" : $STATUS }' | yq --yaml-output > "$STASH/failure.yaml"
                                                                                                                            yq --yaml-output "." "$STASH/failure.yaml" >&2
                                                                                                                            flock -u 202
                                                                                                                            flock -u 201
                                                                                                                            exit 64
                                                                                                                        ...
                                                                                                                        then
                                                                                                                            jq --null-input --arg EXPECTED "${ builtins.concatStringsSep "," point.outputs }" --arg OBSERVED "$( find "$STASH/mount" -mindepth 1 -maxdepth 1 )" --arg STANDARD_ERROR "$( cat "$STASH/standard-error" )" --arg STANDARD_OUTPUT "$( cat "$STASH/standard-output" )" --arg STATUS "$?" '{ "expected" : $EXPECTED  , "failure" :  12733 , "observed" : $OBSERVED , "standard-error" : $STANDARD_ERROR , "standard-output" : $STANDARD_OUTPUT , "status" : $STATUS }' | yq --yaml-output > "$STASH/failure.yaml"
                                                                                                                            yq --yaml-output "." "$STASH/failure.yaml" >&2
                                                                                                                            flock -u 202
                                                                                                                            flock -u 201
                                                                                                                            exit 64
                                                                                                                        ...
                                                                                                                        then
                                                                                                                            jq --null-input --arg EXPECTED "${ builtins.concatStringsSep "," point.outputs }" --arg OBSERVED "$( find "$STASH/mount" -mindepth 1 -maxdepth 1 )" --arg STANDARD_ERROR "$( cat "$STASH/standard-error" )" --arg STANDARD_OUTPUT "$( cat "$STASH/standard-output" )" --arg STATUS "$?" '{ "expected" : $EXPECTED  , "failure" :  23261 , "observed" : $OBSERVED , "standard-error" : $STANDARD_ERROR , "standard-output" : $STANDARD_OUTPUT , "status" : $STATUS }' | yq --yaml-output > "$STASH/failure.yaml"
                                                                                                                            yq --yaml-output "." "$STASH/failure.yaml" >&2
                                                                                                                            flock -u 202
                                                                                                                            flock -u 201
                                                                                                                            exit 64
                                                                                                                        ...
                                                                                                                        jq --null-input --arg EXPECTED "${ builtins.concatStringsSep "," point.outputs }" --arg OBSERVED "$( find "$STASH/mount" -mindepth 1 -maxdepth 1 )" --arg STANDARD_ERROR "$( cat "$STASH/standard-error" )"  --arg STANDARD_OUTPUT "$( cat "$STASH/standard-output" )" --arg STATUS "$?" '{ "expected" : $EXPECTED  , "failure" :  7830 , "observed" : $OBSERVED , "standard-error" : $STANDARD_ERROR , "standard-output" : $STANDARD_OUTPUT , "status" : $STATUS }' | yq --yaml-output > "$STASH/failure.yaml"
                                                                                                                        yq --yaml-output "." "$STASH/failure.yaml" >&2
                                                                                                                        flock -u 202
                                                                                                                        flock -u 201
                                                                                                                        exit 64
