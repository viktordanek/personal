                                                                                        ...
                                                                                        in
                                                                                            ''
                                                                                                ...
                                                                                                then
                                                                                                    ...
                                                                                                    mkdir --parents "$LINK"
                                                                                                    ${ builtins.concatStringsSep "" ( builtins.map ( dependency : builtins.concatStringsSep "\n" ( output : ''if [ ! -e "${ builtins.concatStringsSep "/" [ "$LINKED" ( builtins.trace "572cbd60-698b-46ce-be5d-1e6188076b70" dependency ) ( builtins.trace "c0a58ba1-adeb-4ab0-9122-c5e62853ab0c" output ) ] }" ] ; then ${ yaml 13579 } && rm "$ROOT/lock" && flock -u 201 && exit 64'' ) ( builtins.trace "f5491678-2887-467f-bbd1-ced64b3b7aac ${ builtins.typeOf ( builtins.getAttr dependency outputs ) }" ( builtins.getAttr dependency outputs ) ) ) ( builtins.trace "d9fcfc8c-35d4-4b57-a150-160ef0227383 [[ ${ builtins.concatStringsSep " , " ( builtins.map builtins.typeOf resource.dependencies ) } ]] ${ builtins.toJSON resource.dependencies }" resource.dependencies ) ) }
