                                                                                                            ...
                                                                                                            ''
                                                                                                                case "$1" in
                                                                                                                    0)
                                                                                                                        ...
                                                                                                                        nixos-rebuild build-vm --flake ./work-tree#myhost --override-input personal "/home/${ config.personal.name }/${ config.personal.stash }/linked/personal/repository/personal/work-tree" --override-input secrets "$( "$OUT/boot/repository/age-secrets" )/work-tree" --override-input visitor "/home/${ config.personal.name }/${ config.personal.stash }/linked/personal/repository/personal/work-tree"
