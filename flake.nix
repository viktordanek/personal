                                                ...
                                                pkgs :
                                                    let
                                                        ...
                                                        in
                                                            visitor.lib.implementation
                                                                {
                                                                    lambda = path : value : builtins.trace "2818754a-9411-4521-af9c-9e87013639e2" ( builtins.concatStringsSep " " [ "$(" ( builtins.concatStringsSep "/" ( builtins.concatLists [ [ ( builtins.trace "8bcd185a-f6dc-4cf2-93b5-e34d70b5edd1" derivation ) ] ( builtins.map builtins.toJSON path ) ] ) ) ")" ] ) ;
                                                                }
                                                                configuration ;
