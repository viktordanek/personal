                                                                                                ...
                                                                                                then
                                                                                                    ...
                                                                                                    if [ ! -d ${ _environment-variable "HOME" }/repository ]
                                                                                                        then
                                                                                                            ...
                                                                                                            ${ pkgs.git }/bin/git config core.sshCommand "${ pkgs.openssh }/bin/ssh -i ${ _environment-variable "HOME" }/identity -o StrictHostKeyChecking=true -o UserKnownHostsFile=${ _environment-variable "HOME" }/identity" &&
