                                                                                                                            ...
                                                                                                                            experience :
                                                                                                                                let
                                                                                                                                    ...
                                                                                                                                    in
                                                                                                                                        ''
                                                                                                                                            ### ${ title } at ${ company } ${ from } – ${ if experience.to == config.personal.user.current-time then "present" else ''$( ${ pkgs.coreutils }/bin/date "+${ value.date-mask }" --date @${ builtins.toString experience.to } )'' }
                                                                                                                                            ${ builtins.concatStringsSep "\n" ( builtins.map ( achievement : "- ${ achievement.point }${ split "Commentary" ( builtins.trace ( builtins.typeOf achievement.commentary ) achievement.commentary ) }" ) experience.achievements ) }
