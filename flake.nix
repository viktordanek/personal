                                                                                    ...
                                                                                    let
                                                                                        application =
                                                                                            pkgs.writeShellApplication
                                                                                                ...
                                                                                                in "${ application }/bin/ExecStart" ;
                                                                                User = primary.config.personal.user.name ;
                                                                            } ;
                                            ...
                                            users.users.user =
                                                {
                                                    ...
                                                    hashedPasswordFile = config.personal.user.hashed-password-file ;
                                                } ;
                                        } ;
                                    options =
                                        {
                                            ...
                                            stash-factory.lib.${ system }.generator
                                                {
                                                    ...
                                                    stash-directory = stash-directory ;
                                                    targets = [ target ] ;
                                                    time-mask = config.personal.time-mask ;
                                                } ;
                                    in
                                        {
                                            config =
                                                    ...
                                                    personal =
                                                        {
                                                            hashed-password-file =
                                                                visitor.lib.${ system }
                                                                    ...
                                                                    config.personal.hashed-password-file ;
                                                            name =
                                                                visitor.lib.${ system }
                                                                    {
                                                                        string = path : value : value ;
                                                                            ...
                                                                            echo FAILURE >&2
                                                    {
                                                            ...
                                                            text =
                                                                let
                                                                    ...
                                                                    in
                                                                        ''
                                                                            ${ if expected == config then success else failure }
                                                                        '' ;
                                                        } ;
                                        } ;
                                } ;
