                                                                                                                        ...
                                                                                                                        let
                                                                                                                            ...
                                                                                                                            in
                                                                                                                                ''
                                                                                                                                    ...
                                                                                                                                    ${ builtins.concatStringsSep "\n" ( builtins.map ( path : if [ -L ${ builtins.concatStringsSep "/" ( builtins.concatLists [ [ "" "home" config.personal.name config.personal.stash ( builtins.substring 0 config.personal.hash-length ( builtins.hashString "sha512" ( builtins.toString config.personal.current-time ) ) ) "output" ] ( builtins.map builtins.toJSON path ) [ "teardown" ] ] ) ) } ] ; then ${ builtins.concatStringsSep "/" ( builtins.concatLists [ [ "" "home" config.personal.name config.personal.stash ( builtins.substring 0 config.personal.hash-length ( builtins.hashString "sha512" ( builtins.toString config.personal.current-time ) ) ) "output" ] ( builtins.map builtins.toJSON path ) [ "teardown" ] ] ) ) } ; fi ; ) ) }
                                                                                                                                    ${ release }/bin/release
                                                                                                            ...
                                                                                                            ''
                                                                                                                ...
                                                                                                                then
                                                                                                                    ...
                                                                                                                    then
                                                                                                                        ...
                                                                                                                        then
                                                                                                                            jq --null-input --arg EXTRA "$( find "$STASH/mount -mindepth 1 -maxdepth 1 ${ builtins.map ( name : "! -name ${ name }" ) outputs )" --arg STANDARD_ERROR "$( cat "$STASH/standard-error" )" --arg STANDARD_OUTPUT "$( cat "$STASH/standard-output" )" --arg STATUS "$?" '{ "extra" : $EXTRA , "fault" : 2 , "standard-error" : $STANDARD_ERROR , "standard-output" : $STANDARD_OUTPUT : "status" : $STATUS }' | yq --yaml-output "" > "$STASH/failure.yaml"
                                                                                                                            flock -u 202
                                                                                                                            flock -u 201
                                                                                                                            exit 64
