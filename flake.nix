                                                                                                            ...
                                                                                                            let
                                                                                                                experience =
                                                                                                                    let
                                                                                                                        mapper =
                                                                                                                            experience :
                                                                                                                                ''### ${ experience.title } at ${ experience.company } $( ${ pkgs.coreutils }/bin/date "+${ value.date-mask }" --date @${ builtins.toString experience.from } ) – ${ if experience.to == config.personal.users.current-time then "present" else ''$( ${ pkgs.coreutils }/bin/date "+${ value.date-mask }" --date @${ builtins.toString experience.to } )'' }'' ;
                                                                                                                        ...
                                                                                                                        forward-reducer =
                                                                                                                            previous : current :
                                                                                                                                let
                                                                                                                                    ...
                                                                                                                                    in builtins.concatLists [ previous [ ultimate ] ] ;
                                                                                                                        in builtins.map mapper ( builtins.foldl' forward-reducer [ ] ( builtins.sort ( a : b : a.from > b.from ) ( builtins.foldl' backward-reducer [ ] ( builtins.sort ( a : b : a.from < b.from ) ( builtins.filter ( experience : experience.to - experience.from > value.filter ) config.personal.user.career.experience ) ) ) ) ) ;
                                                                                                                in
