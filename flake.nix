                                                ...
                                                mapper =
                                                    resource :
                                                        let
                                                            ...
                                                            index =
                                                                let
                                                                    indexed = builtins.genList ( index : { index = index ; value = builtins.elemAt index sort ; } ) ( builtins.length sorted ) ;
                                                                    ...
                                                                    in builtins.length ( builtins.trace ( builtins.toJSON index ) index_ ) ;
